...
This is the third project of the second semester of Udacity's self driving car nanodegree. In this project we will implement a 2 dimensional particle filter in C++ to find the location of moving car on the map. The particle filter will be given a map and some initial localization information (analogous to what a GPS would provide). At each time step the filter will also get observation and control data. 
